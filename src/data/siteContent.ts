...
export const breakfastSection = {
  ...
  // ⚠️ TODO(client): שמות מנות ומחירים אמיתיים
  items: [
    { name: "[שם מנה — לאישור לקוח]", description: "[תיאור מנה — לאישור לקוח]" },
    { name: "[שם מנה — לאישור לקוח]", description: "[תיאור מנה — לאישור לקוח]" },
    { name: "[שם מנה — לאישור לקוח]", description: "[תיאור מנה — לאישור לקוח]" },
  ],
};
...
export const aboutSection = {
  ...
  // טקסט placeholder מכובד — אין להמציא עובדות. יש להחליף בתוכן אמיתי לאחר קבלתו מהלקוח.
  paragraphs: [
    "אופרה נולדה מתוך אהבה לפטיסרי מדויק ולקינוחי פירות שמשלבים טעם, מרקם ומראה בלתי נשכח.",
    "[פסקה זו היא placeholder — יש להשלים סיפור מותג אמיתי לאחר קבלתו מהלקוח.]",
  ],
  factsNeeded: [
