...
const menuCategories = [
  ...
  },
  {
    ...
    description: "יצירות בעבודת יד ומאפים טריים מדי יום. ⚠️ פירוט מלא יעודכן מהלקוח.",
    href: "/",
  },
  {
    id: "breakfast",
    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
        <SectionHeading
          ...
          paragraph="תפריט חלבי כשר — מהבייקרי של הבוקר, דרך הפיצה מהטאבון ועד קינוח הפירות שאי אפשר לא לצלם. פריטים ומחירים מדויקים ⚠️ ממתינים לאישור סופי מהלקוח."
          align="center"
        />
